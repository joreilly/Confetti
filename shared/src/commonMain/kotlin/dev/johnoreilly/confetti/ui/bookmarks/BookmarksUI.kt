...
fun BookmarksUI(
    ...
    val pastSessions by component.pastSessions.collectAsStateWithLifecycle(initialValue = emptyMap())
    val upcomingSessions by component.upcomingSessions.collectAsStateWithLifecycle(initialValue = emptyMap())
